...
document.querySelectorAll('a, button, .tag, .about-card').forEach(el => {
...
const revealEls = document.querySelectorAll(
  '.section-title, .about-text, .about-card, .skill-group, .project-card, .contact-card, .certif-item, .gallery-tab'
);
